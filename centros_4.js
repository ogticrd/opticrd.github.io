const centros = [
  ...
  },
  {
    ...
    centers: [
      ...
      { name: "CORAASAN" },
      { name: "CENTRO BEJUCAL" },
      { name: "CENTRO BN LA HERRADURA" },
      { name: "CENTRO BUEN PASTOR" },
      { name: "CENTRO CAIMITO" },
      { name: "CENTRO DON JUAN" },
      { name: "CENTRO EL RUBIO" },
      { name: "CENTRO HATO DEL YAQUE" },
      { name: "CENTRO INOA" },
      { name: "CENTRO JANEY " },
      { name: "CENTRO JUNCALITO" },
      { name: "CENTRO LA CANELA " },
      { name: "CENTRO LA CIDRA " },
      { name: "CENTRO LA CUESTA" },
      { name: "CENTRO LAS CHARCAS" },
      { name: "CENTRO LAS MANACLAS" },
      { name: "CENTRO LAS PLACETAS" },
      { name: "CENTRO LOS GUANDULES" },
      { name: "CENTRO LOS MONTONES " },
      { name: "CENTRO MAMATINGO" },
      { name: "CENTRO PILONES " },
      { name: "CENTRO PINALITO" },
      { name: "CENTRO PLATANAL" },
      { name: "CENTRO RINCON DE PIEDRA" },
      { name: "CENTRO VILLA BAO" },
