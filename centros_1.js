const centros1 = [
  {
    ...
    municity: [
      ...
      {
        name: "SAN LUISS DAS I",
        center: [{ name: "CENTRO DIAGNOSTICO SAN LUIS" }],
      },
      ...
      {
        name: "GUARICANO (DAS III)",
        center: [{ name: "BIBLIOTECA MULTIUSO GUARICANO CENTRO" }],
      },
      {
        name: "VISTA BELLA (DAS III)",
        center: [{ name: "CLUB LOS MOSQUITOS" }],
      },
      {
      ...
      {
        name: "NUEVA BARQUITA (DAS III)",
        center: [{ name: "CENTRO DIAGNOSTICO NUEVA BARQUITA" }],
      },
      { name: "CAPOTILLO DAS IV", center: [{ name: "CPN VALENTIN BOTEN" }] },
      {
        name: "CRISTO REY DAS IV",
        center: [{ name: "FUNDACION CRUZ JIMINIAN" }],
      },
      { name: "ENS. CAPOTILLO DAS IV", center: [{ name: "FUNDACION JUDEGU" }] },
      {
        name: "DAS IV",
        center: [{ name: "SOCIEDAD BENEFICA PRO-EMIGRANTES ESPAÑOLES" }],
      },
      ...
      {
        name: "VILLA JUANA   ( DAS IV)",
        center: [{ name: "CLUB MAURICIO BÁEZ" }],
      },
      {
        name: "VILLA CONSUELO  ( DAS IV)",
        center: [{ name: "CLUB RAFAEL BARÍAS" }],
      },
      {
        name: "VILLA CONSUELO  ( DAS IV)",
        center: [{ name: "HOSPITAL DR. FÉLIX MARÍA GOICO" }],
      },
      {
        name: "SIMÓN BOLÍVAR  ( DAS IV)",
        center: [{ name: "POLITÉCNICO NUESTRA SRA. DEL CARMEN" }],
      },
      {
        name: "GUALEY  ( DAS IV)",
        center: [{ name: "ESCUELA FÁTIMA OSCAR SANTANA" }],
      },
      {
        name: "DOMINGO SAVIO  ( DAS IV)",
        center: [{ name: "CONSULTORIO MÉDICO LA CIÉNAGA" }],
      },
      {
        name: "MARÍA AUXILIADORA  ( DAS IV)",
        center: [{ name: "CLUB MARÍA AUXILIADORA" }],
      },
      {
        name: "MEJORAMIENTO SOCIAL (DAS IV)",
        center: [{ name: "DISPENSARIO PARROQUIAL SAN GABRIEL" }],
      },
      {
        name: "LOS PRADOS (DAS V)",
        center: [
      ...
      {
        name: "GAZCUE (DAS V)",
        center: [{ name: "UNIVERSIDAD IBEROAMERICANA (UNIBE)" }],
      },
      {
        name: "ZONA UNIVERSITARIA (DAS V)",
        center: [
      ...
      {
        name: "URB. REAL (DAS V)",
        center: [{ name: "CLUB PLAZA INDEPENDENCIA" }],
      },
      {
        name: "ENS. NACO (DAS V)",
        center: [{ name: "CLUB NACO" }, { name: "CENTRO OLIMPICO" }],
      },
      {
        name: "ENSANCHE LA FE  DAS VI",
        center: [
      ...
      {
        name: "JARDINES DEL NORTE (DAS VI)",
        center: [
          { name: "UNIVERSIDAD NACIONAL PEDRO HENRIQUEZ UREÑA  (UNPHU)" },
        ],
      },
      {
        name: "LAS CAOBAS (DAS VII)",
        center: [{ name: "ASOCIACION DE IMPEDIDO FISICO-MOTORES" }],
      },
      {
        name: "EL ABANICO (DAS VII)",
        center: [{ name: "SALON MULTIUSO DEL ABANICO" }],
      },
      {
        name: "LAS CAOBAS (DAS VII)",
        center: [{ name: "MULTIUSOS DE LA CAOBA" }],
      },
      {
        name: "MANOGUAYABO (DAS VII)",
        center: [{ name: "CAPILLA BIENVENIDO" }],
      },
      {
        name: "BARRIO ENRIQUILLO (DAS VII)",
        center: [{ name: "IGLESIA LAS MERCEDES " }],
      },
      {
        name: "EL LIBERTADOR (DAS VII)",
        center: [{ name: "IGLESIA DE LOS MORMONES " }],
      },
      {
        name: "BUENOS AIRES (DAS VII)",
        center: [{ name: "IGLESIA DE LOS MORMONES " }],
      },
      {
        name: "HERRERA (DAS VII)",
        center: [{ name: "COOPERATIVA DE HERRERA" }],
      },
      {
        name: "HERRERA (DAS VII)",
        center: [{ name: "HOSPITAL DR MARCELINO VELEZ" }],
      },
      {
        name: "HERRERA (DAS VII)",
        center: [{ name: "CLUB NUEVO AMBIENTE" }],
      },
      {
        name: "BARRIO ENRIQUILLO (DAS VII)",
        center: [{ name: "IGLESIA SAN PEDRO NOLASCO" }],
      },
      {
        name: "EL CAFÉ DE HERRERA (DAS VII)",
        center: [{ name: "CLUB CAJUQUIS" }],
      },
      {
        name: "HERRERA (DAS VII)",
        center: [{ name: "FUNDACION CARGLAXITON" }],
      },
      {
        name: "EL CAFÉ DE HERRERA (DAS VII)",
        center: [{ name: "CENTRO COMUNITARIO LAS MINA" }],
      },
      {
        name: "BARRIO ENRIQUILLO (DAS VII)",
        center: [{ name: "IGLESIA LA CHONTA" }],
      },
      {
        name: "BARRIO ENRIQUILLO (DAS VII)",
        center: [{ name: "IGLESIA CATOLICA DIVINO NINO" }],
      },
      {
        name: "BARRIO DUARTE (DAS VII)",
        center: [{ name: "IGLESIA NUEVA VIDA EN CRISTO " }],
      },
      {
        name: "LAS PALMAS (DAS VII)",
        center: [{ name: "CENTRO DE LA ATENCION PRIMARIA EL MARJANZO" }],
      },
      {
        name: "MANOGUAYABO (DAS VII)",
        center: [{ name: "IGLESIA CATOLICA" }],
      },
      {
        name: "HERRERA (DAS VII)",
        center: [{ name: "MULTIOSO IVAN KLNAG" }],
      },
      {
        name: "BAYONA (DAS VII)",
        center: [{ name: "MISION ENMANUEL " }],
      },
      {
        name: "BAYONA (DAS VII)",
        center: [{ name: "MULTIOSO SANTO SOCORRO" }],
      },
      {
        name: "BUENOS AIRES (DAS VII)",
        center: [{ name: "CENTRO DE CAPACITACION (OSCUS)" }],
      },
      {
        name: "SAN MIGUEL (DAS VII)",
        center: [{ name: "SALON MULTIUSO " }],
      },
      {
        name: "BELLAS COLINAS (DAS VII)",
        center: [{ name: "MULTIOSO PROGRESANDO EN VALORES" }],
      },
      {
        name: "MANOGUAYABO (DAS VII)",
        center: [{ name: "IGLESIA PALAVE" }],
      },
      {
        name: "HATO NUEVO (DAS VII)",
        center: [{ name: "IGLESIA " }],
      },
      {
        name: "CABAYONA (DAS VII)",
        center: [{ name: "IGLESIA" }],
      },
      {
        name: "LA CIENEGA (DAS VII)",
        center: [{ name: "IGLESIA CATOLICA  NUESTRA SENORA DE LOURDES" }],
      },
      {
        name: "AV. CORDILLERA (DAS VII)",
        center: [{ name: "CENTRO COMUNAL " }],
      },
      {
        name: "PANTOJA (DASVIII)",
        center: [
          ...
          {
            name:
              "FUNDACION PARA EL MEJORAMIENTO DE LOS ENVEJECIENTES DOMINICANO (FUMEDO)",
          },
        ],
      },
    ],
    ...
    municity: [
      {
        ...
        center: [{ name: "HOGAR DE ANCIANO NUESTRA SEÑORA DE FATIMA" }],
      },
      {
        name: "MONTE PLATA",
        center: [{ name: "HOGAR DE DIA CARMEN CUADRADO" }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "DON GREGORIO",
        center: [{ name: "CPN DON GREGORIO" }],
      },
      {
        name: "SANTANA",
        center: [{ name: "CPN SANTANA" }],
      },
      {
        name: "PIZARRETE",
        center: [{ name: "CPN PIZARRETE" }],
      },
      {
        name: "LAS BARIAS",
        center: [{ name: "CPN LAS BARIAS" }],
      },
      {
        name: "CATALINA",
        center: [{ name: "CPN CATALINA" }],
      },
      {
        name: "EL CARRETON",
        center: [{ name: "CPN EL CARRETON" }],
      },
      {
        name: "PAYA",
        center: [{ name: "CPN PAYA" }],
      },
      {
        name: "ESCONDIDO",
        center: [{ name: "CPN ESCONDIDO" }],
      },
      {
        name: "MATA GORDA",
        center: [{ name: "CPN MATA GORDA" }],
      },
      {
        name: "FUNDACION DE PERAVIA",
        center: [{ name: "CPN FUNDACION DE PERAVIA" }],
      },
      {
        name: "RIO ARRIBA",
        center: [{ name: "CPN RIO ARRIBA" }],
      },
      {
        name: "EL LIMONAL",
        center: [{ name: "CPN EL LIMONAL" }],
      },
      {
        name: "VALDESIA",
        center: [{ name: "CPN VALDESIA" }],
      },
      {
        name: "LOS YAGUARIZOS",
        center: [{ name: "CPN LOS YAGUARIZOS" }],
      },
      {
        name: "VILLA GUERA",
        center: [{ name: "CPN VILLA GUERA" }],
      },
      {
        name: "MAXIMO GOMEZ",
        center: [{ name: "CPN MAXIMO GOMEZ" }],
      },
      {
        name: "SAONA",
        center: [{ name: "CPN SAONA" }],
      },
      {
        name: "VILLA DAVID",
        center: [{ name: "CPN VILLA DAVID" }],
      },
      {
        name: "CAÑAFISTOL",
        center: [{ name: "CPN CAÑAFISTOL" }],
      },
      {
        name: "LAS TABLAS",
        center: [{ name: "CPN LAS TABLAS" }],
      },
      {
        name: "HONDURAS",
        center: [{ name: "CPN HONDURAS" }],
      },
      {
        name: "LAS CARRERAS",
        center: [{ name: "CPN LAS CARRERAS" }],
      },
      {
        name: "VILLA SOMBRERO",
        center: [{ name: "CPN VILLA SOMBRERO" }],
      },
      {
        name: "MATANZAS",
        center: [{ name: "CPN MATANZAS" }],
      },
      {
        name: "LOS TUMBAOS",
        center: [{ name: "CPN LOS TUMBAOS" }],
      },
      {
        name: "QUIJA QUIETA",
        center: [{ name: "CPN QUIJA QUIETA" }],
      },
      {
        name: "ARROYO HONDO",
        center: [{ name: "CPN ARROYO HONDO" }],
      },
      {
        name: "LAS CALDERAS",
        center: [{ name: "CPN LAS CALDERAS" }],
      },
      {
        name: "SABANA BUEY",
        center: [{ name: "CPN SABANA BUEY" }],
      },
      {
        name: "SALINAS",
        center: [{ name: "CPN SALINAS" }],
      },
      {
        name: "SANTA ROSA",
        center: [{ name: "CPN SANTA ROSA" }],
      },
      {
        name: "BOCA CANASTA",
        center: [{ name: "CPN BOCA CANASTA" }],
      },
      {
        name: "EL LLANO",
        center: [{ name: "CPN EL LLANO" }],
      },
      {
        name: "VILLA MAJEGA",
        center: [{ name: "CPN VILLA MAJEGA" }],
      },
      {
        name: "WILSON BELLO",
        center: [{ name: "CPN WILSON BELLO" }],
      },
      {
        name: "NIZAO",
        center: [
    ...
    municity: [
      ...
      },
      {
        ...
        center: [
          {
            name:
              "PUESTO VACUNACION LOS JOBOS 2, CARIZAL, MAJAGUAL, EL HIGUERO, Y JOBO 1",
          },
        ],
      },
      {
        ...
        center: [
          {
            name: "PUESTO VACUNACION UNAPS, LAS LOMAS, VILLA CORAZON, EL BARRO",
          },
        ],
      },
      {
        ...
        center: [
          {
            name:
              " PUESTO VACUNACION UNAPS  PROYECTO 4, ANZONIA, PUEBLO VIEJO, YAYA1, YAYA2, VIAJAMA, HATO NUEVO, TABARA ARRIBA",
          },
        ],
      },
      {
        ...
        center: [
          {
            name:
              "PUESTO VACUNACION UNAPS YAYAS #1, AMIAMA GOMEZ, SAJANOA, LOS TOROS.",
          },
        ],
      },
      {
        ...
        center: [
          {
            name:
              "PUESTO VACUNACION UNAPS, VILLA OCOA, SANTA ANA, MONTE BONITO, LAS LAGUNA, LA SIEMBRA, CAÑITA-A, LOS FRIOS.",
          },
        ],
      },
      { name: "PALMAR DE OCOA", center: [{ name: "UNAP PALMAR DE OCOA" }] },
      {
        ...
        center: [
          {
            name:
              "PUESTO VACUNACION UNAPS CHARCAS, HATILLO, ARROLLO COLORADO, SABANA YEGUA, SAN FCO",
          },
        ],
      },
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "SANTIAGO I  VILLA GONZALEZ",
        center: [
          { name: "EL LIMÓN" },
          { name: "PALMAR ARRIBA" },
          { name: "PALMAR ABAJO" },
      ...
      {
        name: "SANTIAGO III, TAMBORIL",
        center: [{ name: "HOSPITAL MUNICIPAL TAMBORIL" }],
      },
      {
        name: "SANTIAGO III, PUÑAL",
        center: [
      ...
      {
        name: "SANTIAGO III, BAITOA",
        center: [{ name: "HOSPITAL DE BAITOA " }],
      },
    ],
  },
  {
    ...
    municity: [
      {
        ...
        center: [
          ...
          {
            name:
              "PARQUE JUAN GARCÍA, SECTOR GREGORIO LUPERÓN, SAN FELIPE DE PUERTO PLATA",
          },
        ],
      },
      {
        name: "PADRE DE LAS CASAS",
        center: [{ name: "PLAY DEL SECTOR PADRE LAS CASAS" }],
      },
      {
        name: "GUANANICO",
        center: [{ name: "HOSPITAL MUNICIPAL DE GUANANICO" }],
      },
      {
        name: "VILLA ISABELLA",
        center: [{ name: "HOSPITAL MUNICIPAL DE VILLA ISABELA" }],
      },
    ],
  },
  {
    ...
    municity: [
      ...
      {
        name: "VILLA RIVAS",
        center: [{ name: "MULTIUSO BAJO TECHO VILLA RIVAS" }],
      },
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "LIMON",
        center: [{ name: "CENTRO TECNOLOGICO LINCOLN" }],
      },
      {
        name: "LAS GALERAS",
        center: [
      ...
      {
        name: "ARROYO BARRIL",
        center: [{ name: "LOS ROBALOS (CENTRO COMUNAL)" }],
      },
      {
        name: "SANCHEZ",
        center: [
  ...
  },
  {
    ...
    municity: [
      {
        name: "SALCEDO",
        center: [{ name: "CASA DE LA TERCERA EDAD" }],
      },
      {
        name: "VILLA TAPIA",
        center: [{ name: "HOGAR DE ANCIANO PADRE NOEL" }],
      },
      {
        name: "TENARES",
        center: [{ name: "CASA MANUEL FLORENTINO" }],
      },
      {
        name: "SALCEDO",
        center: [{ name: "ASOCIACION MEDICA" }],
      },
      {
        name: "SALCEDO",
        center: [{ name: "CASA DE LOS JOVENES DE AYER" }],
      },
    ],
  },

  {
    ...
    municity: [
      ...
      {
        name: "VICENTE NOBLE",
        center: [{ name: "HOSPITAL MUNICIPAL VICENTE NOBLE" }],
      },
      {
        name: "DISTRITO MUNICIPAL LA CIÉNAGA",
        center: [{ name: "HOSPITAL MUNICIPAL VICENTE NOBLE" }],
      },
      {
        name: "DISTRITO MUNICIPAL PARAÍSO",
        center: [
          { name: "MULTIUSO" },
      ...
      },
      {
        ...
        center: [{ name: "AYUNTAMIENTO DE ENRIQUILLO" }],
      },
      { name: "QUITA CORAZA (DM)", center: [{ name: "UNAP DE QUITA CORAZA" }] },
      { name: "LOS PATOS (DM)", center: [{ name: "LICEO DE LOS PATOS" }] },
      {
        name: "ARROYO DULCE (SECCION)",
        center: [{ name: "ESCUELA PRIMARIA DE ARROLLO DULCE" }],
      },
    ],
  },
  {
    ...
    municity: [
      ...
      {
        name: "EL SALADO",
        center: [{ name: "UNAP EL SALADO" }],
      },
      {
        name: "GALVÁN",
        center: [{ name: "UNAP GALVÁN" }],
      },
      {
        name: "TAMAYO",
        center: [{ name: "UNAPTAMAYO" }],
      },
      {
        name: "VILLA JARAGUA",
        center: [{ name: "UNAP VILLA JARAGUA" }],
      },
      {
        name: "LOS RÍOS",
        center: [{ name: "UNAP LOS RÍOS" }],
      },
      {
        name: "CLAVELLINAS",
        center: [{ name: "UNAP CLAVELLINAS" }],
      },
    ],
  },
  {
    ...
    municity: [
      ...
      {
        name: "CRISTÓBAL",
        center: [{ name: "CPN CRISTÓBAL." }, { name: "CPN BATEY 8." }],
      },
      {
        name: "LA DESCUBIERTA",
        center: [
  ...
  },
  {
    ...
    municity: [
      {
        name: "PEDERNALES",
        center: [{ name: "UNAP 3 Y 4" }, { name: "UNAP  5 Y 6" }],
      },
      {
        name: "OVIEDO",
        center: [{ name: "UNAP 7 Y 8" }, { name: "UNAP  9" }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    municity: [
      ...
      { name: "LA MALENA", center: [{ name: "UNAP LA MALENA" }] },
      {
        ...
        center: [{ name: "UNAP JUAN PABLO DUARTE" }],
      },
      ...
      {
        name: "LLANADA DEL CERRO",
        center: [{ name: "UNAP LLANADA DEL CERRO" }],
      },
      ...
      {
        name: "PEÑON DE LOS REYES",
        center: [{ name: "UNAP PEÑON DE LOS REYES" }],
      },
      ...
      {
        name: "LAS LAGUNAS DE NISIBON",
        center: [{ name: "CENTRO COMUNAL LAS LAGUNAS DE NISIBON " }],
      },
      {
        name: "LA OTRA BANDA",
        center: [{ name: "CENTRO COMUNAL LA OTRA BANDA" }],
      },
      {
        name: "VERON",
        center: [
      ...
      {
        name: "SAN RAFAEL DE YUMA",
        center: [{ name: "CENTRO COMUNAL SAN RAFAEL DE YUMA" }],
      },
      {
        name: "PUNTA CANA",
        center: [
          {
            name:
              "CENTRO MÉDICO PUNTA CANA. AVENIDA ESTADOS UNIDOS, PUNTA CANA",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "PEDRO SANTANA",
        center: [{ name: "CPN PEDRO SANTANA" }, { name: "CPN LAS PALMAS" }],
      },
      {
        name: "JUAN SANTIAGO",
        center: [
  ...
  },
  {
    ...
    municity: [
      {
        name: "LAGUNA SALADA",
        center: [{ name: "CLINICA MONTESINO" }, { name: "UNAP CENTRO" }],
      },
      {
        name: "MAO",
        center: [{ name: "COLEGIO MEDICO" }, { name: "CLUB DE LEONES" }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "PEPILLO SALCEDO (MANZANILLO)",
        center: [
          { name: "POLIDEPORTIVO" },
          { name: "CARBONERA" },
          { name: "UNAP COPEY" },
      ...
      {
        name: "PALO VERDE",
        center: [{ name: "IGLESIA" }, { name: "PLEY MAGDALENA (CARPA)" }],
      },
      {
        name: "GUAYUBIN",
        center: [
      ...
      {
        name: "PEPILLO SALCEDO (MANZANILLO)",
        center: [{ name: "EN EL PARQUE MANOLO TAVAREZ" }],
      },
  ...
  },
  {
    ...
    municity: [
      {
        name: "LOS QUEMADOS",
        center: [{ name: "DISTRITO MUNICIPAL LOS QUEMADOS" }],
      },
      {
        name: "JUMA BEJUCAL",
        center: [{ name: "DISTRITO MUNICIPAL JUMA BEJUCAL" }],
      },
  ...
  },
  {
    ...
    municity: [
      ...
      {
        name: "EL PINO",
        center: [{ name: "HOSPITAL PROFESOR JUAN BOSCH" }],
      },
      {
        name: "RIO VERDE ARRIBA",
        center: [{ name: "HOSPITAL JUAN ANT.CASTILLO" }],
      },
      {
        name: "JIMA ABAJO",
        center: [{ name: "HISPITAL JIMA ABAJO" }],
      },
    ],
  },
  {
